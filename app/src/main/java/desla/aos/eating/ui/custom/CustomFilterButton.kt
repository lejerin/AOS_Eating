...
import kotlinx.android.synthetic.main.view_filter_btn_custom.view.*
...
open class CustomFilterButton @JvmOverloads constructor(context: Context, attrs: AttributeSet?=null, defStyleAttr: Int=0)
    ...
    init {
        ...
        typedArray.getBoolean(R.styleable.CustomFilterButton_isLarge, false).let {
            if(it){
                View.inflate(context, R.layout.view_filter_btn_custom_large, this)
            }else{
                View.inflate(context, R.layout.view_filter_btn_custom, this)
            }
        }
