package desla.aos.eating.ui.main.home.post
...
class PostActivity :  BaseActivity<ActivityPostBinding>() {
    ...
    override fun initDataBinding() {
        val items = arrayOf("2명", "3명", "4명")
        val adapter = ArrayAdapter(this, R.layout.item_spinner_post, items)
        ...
        viewDataBinding.spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            ...
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                ...
                viewModel.data.memberCountLimit = position + 2
               if(isFirstSpinner){
