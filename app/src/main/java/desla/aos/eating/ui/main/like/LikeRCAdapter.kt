...
class LikeRCAdapter (
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = when (viewType)
    {
        ...
        {//inflates progressbar layout
            val view = LayoutInflater.from(parent.context).inflate(R.layout.item_like_chat_title,parent,false)
        ...
        {//inflates progressbar layout
            val view = LayoutInflater.from(parent.context).inflate(R.layout.item_like_title,parent,false)
